...
export const GanttSidebarItem: FC<GanttSidebarItemProps> = ({
  ...
  return (
    <div
      className={cn(
        "group relative flex items-center gap-2.5 p-2.5 text-xs hover:bg-secondary",
        className
      )}
      key={feature.id}
      onClick={handleClick}
    ...
    >
      ...
      {onDeleteItem && (
        <button
          onClick={(e) => { e.stopPropagation(); onDeleteItem(feature.id) }}
          className="pointer-events-auto ml-1 opacity-0 group-hover:opacity-100 transition-opacity text-muted-foreground hover:text-destructive"
        >
...
export const GanttSidebarHeader: FC<{ count?: number }> = ({ count }) => (
  <div
  ...
  >
    <div className="flex items-center gap-1.5">
      <p className="truncate text-left">Tactics</p>
      {count !== undefined && (
...
export const GanttSidebar: FC<GanttSidebarProps> = ({
  ...
  >
    <GanttSidebarHeader count={count} />
...
export const GanttFeatureDragHelper: FC<GanttFeatureDragHelperProps> = ({
  ...
  return (
    <div
      className={cn(
        "group -translate-y-1/2 !cursor-col-resize absolute top-1/2 z-[3] h-full w-6 rounded-md outline-none bg-transparent",
...
export const GanttFeatureItemCard: FC<GanttFeatureItemCardProps> = ({
  ...
  return (
    <div
      className={cn(
        "flex h-full w-full items-center justify-between gap-2 text-left rounded-md bg-card px-2 text-xs shadow-sm",
