        ...
        <Tabs defaultValue='inbox' className='gap-0'>
          ...
          <TabsContent value='inbox'>
            <DropdownMenuItem className='gap-3 px-2 py-3 text-base'>
              ...
              <div className='flex w-full flex-col items-start'>
                ...
                <div className='flex items-center gap-2.5'>
                  ...
                  <span className='text-muted-foreground text-sm'>New organization</span>
                </div>
              </div>
            ...
            <DropdownMenuItem className='gap-3 px-2 py-3 text-base'>
              ...
              <div className='flex w-full flex-col items-start'>
                ...
                <div className='flex items-center gap-2.5'>
                  ...
                  <div className='bg-muted size-1.5 rounded-full' />
                  <span className='text-muted-foreground text-sm'>Business linked</span>
                </div>
              </div>
              <div className='flex flex-col items-center gap-3'>
                <XIcon className='text-foreground size-3.5' />
            ...
            <DropdownMenuItem className='items-start gap-3 px-2 py-3 text-base'>
              ...
              <div className='flex w-full flex-col items-start'>
                <span className='text-base font-medium'>Anna has applied to join the platform</span>
                <div className='flex items-center gap-2.5'>
                  <span className='text-muted-foreground text-sm'>2 hours ago</span>
                  <div className='bg-muted size-1.5 rounded-full' />
                  <span className='text-muted-foreground text-sm'>New access request</span>
                </div>
            ...
            <DropdownMenuItem className='items-start gap-3 px-2 py-3 text-base'>
              ...
              <div className='flex w-full flex-col items-start'>
                <span className='text-base font-medium'>Jason attached a report</span>
                <div className='flex items-center gap-2.5'>
                ...
                <div className='mt-3 flex items-center gap-1.5'>
                  ...
                  <span className='text-sm'>Q4-Report-2025.pdf</span>
                </div>
              </div>
            </DropdownMenuItem>
          </TabsContent>
          ...
          <TabsContent value='general'>
            ...
            <DropdownMenuItem className='items-start gap-3 px-2 py-3 text-base'>
              ...
              <div className='flex w-full flex-col items-start'>
                ...
                <div className='mt-3 flex items-center gap-1.5'>
                  <LinkIcon className='text-foreground size-4' />
                  <span className='text-sm'>Fund-Overview.pdf</span>
                </div>
              </div>
            </DropdownMenuItem>
            <DropdownMenuSeparator />
            ...
            <DropdownMenuItem className='items-start gap-3 px-2 py-3 text-base'>
              ...
              <div className='flex w-full flex-col items-start'>
                <span className='text-base font-medium'>Rosie requested platform access</span>
                <div className='flex items-center gap-2.5'>
